-- Password vault rows: ciphertext + IV + salt are client-side (zero-knowledge); server never sees plaintext.
-- Prefer running setup_passwords_table.sql in the SQL Editor if this migration was never applied.
